...
import NotificationSnackbar from "../common-components/ui/NotificationSnackbar";
...
export function NotificationContext({ children }) {
	...
	return (
		<>
			<AlertContextUpdate.Provider value={alertSettings}>{children}</AlertContextUpdate.Provider>
