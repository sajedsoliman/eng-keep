...
function WordCardHeader({ wordData, id, audioRef, wordImage, listRef, limit, period }) {
			...
			<header className="flex items-center">
				...
				<RouterLink
					...
					onClick={() => {
						...
						localStorage.setItem("last-limit", limit);
						localStorage.setItem("last-period", period);
					}}
